...
WebApp.connectHandlers.use(connect.urlencoded({limit: '1024mb'})); //Override default request size
WebApp.connectHandlers.use(connect.json({limit: '1024mb'})); //Override default request size
