login_services = {
  ...
  'https://lantern.cottagelabs.com': {
    ...
    text: "Hi!\r\n\r\nPlease go to the link below to sign in to your account:\r\n\r\n{{URL}}\r\n\r\nOr enter this code into the login page: {{CODE}}\r\n\r\nNote: this single-use login is only valid for {{TIMEOUT}} minutes.\r\nThis is an automated email. Replies are NOT monitored.",
    html: '<html><body><p>Hi!</p><p>Please go to the link below to sign in to your account:<p><a href="{{URL}}">{{URL}}</a></p><p>Or enter this code into the login page: {{CODE}}</p><p>Note: this single-use login is only valid for {{TIMEOUT}} minutes.<br><br>This is an automated email. Replies are NOT monitored.</p></body></html>'
  }
}
