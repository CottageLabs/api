login_services = {
  ...
  'https://openaccessbutton.org/login': {
    ...
    html: '<html><body><p>Hi there!</p><p>Thanks for using Open Access Button!</p><p>Please go to the link below to authenticate your account:<p style="margin-left:2em;"><font size="-1"><a href="{{URL}}">{{URL}}</a></font></p><p><font size="-1">Note: this single-use login link is only valid for {{TIMEOUT}}.</font></p><p>In future you can find your account details, ongoing requests, and instrutions at:</p><p><a href="https://openaccessbutton.org/account">https://opendatabutton.org/account</a></p><p>We look forward to helping you find articles,</p><p>Joe</p><p>p.s We are still testing and building the Open Access Button. If you have feedback at any point, let us know:</p><p><a href="https://opendatabutton.org/general-feedback">https://opendatabutton.org/general-feedback</a></p></body></html>'
  },
